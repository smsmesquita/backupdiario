...
class NovoMainWindow(QMainWindow, Ui_MainWindow2,QTreeWidget):
    ...
    def criador_tabela_geral(self):
        ...
        print('chegou')
        cursor.execute (f"""
                CREATE TABLE IF NOT EXISTS {str('Cliente')+ titulo + str('saida')} (
                ...
                inscricao_emitente TEXT NOT NULL, 
                cnpj_destinatario TEXT NOT NULL, 
                nome_destinatario TEXT NOT NULL, 
                logradouro_destinatario TEXT NOT NULL, 
                numero_destinatario TEXT NOT NULL, 
                complemento_destinatario TEXT NOT NULL, 
                bairro_destinatario TEXT NOT NULL, 
                codigo_municipio_destinatario TEXT NOT NULL, 
                Municipio_destinatario TEXT NOT NULL, 
                uf_destinatario TEXT NOT NULL, 
                cep_destinatario TEXT NOT NULL, 
                inscricao_destinatario TEXT NOT NULL, 
                ...
                cod_origem70 TEXT NOT NULL, 
                Base_ICMS70 TEXT NOT NULL, 
                Percentagem_ICMS70 TEXT NOT NULL, 
                Valor_ICMS70 TEXT NOT NULL,
                CST_ICMS90 TEXT NOT NULL,
                CST_PIS TEXT NOT NULL, 
                Base_PIS TEXT NOT NULL, 
                Percentagem_PIS TEXT NOT NULL, 
                Valor_PIS TEXT NOT NULL, 
                CST_COFINS TEXT NOT NULL, 
                Base_COFINS TEXT NOT NULL, 
                Percentagem_COFINS TEXT NOT NULL, 
                Valor_COFINS TEXT NOT NULL, 
                ...
                """)
        cursor.execute (f"""
                CREATE TABLE IF NOT EXISTS {str('Cliente')+ titulo + str('entrada')} (
                Idtabela int(11) NOT NULL,
                nfe TEXT NOT NULL,
                serie TEXT NOT NULL,
                data_emissao TEXT NOT NULL,
    ...
    def criador_tabela_analitica(self):
        ...
        cursor.execute (f"""
                CREATE TABLE IF NOT EXISTS {str('Cliente')+ titulo1 + str('saida')}  (
                nfe TEXT,
                serie TEXT,
                data_emissao TEXT,
                cnpj_emitente TEXT,
                ...
                cod_origem70 TEXT, 
                Base_ICMS70 TEXT, 
                Percentagem_ICMS70 TEXT, 
                Valor_ICMS70 TEXT,
                CST_ICMS90 TEXT,
                CST_PIS TEXT, 
                Base_PIS TEXT, 
                Percentagem_PIS TEXT, 
                Valor_PIS TEXT, 
                CST_COFINS TEXT, 
                Base_COFINS TEXT, 
                Percentagem_COFINS TEXT, 
                Valor_COFINS TEXT, 
        ...
        cursor.execute (f"""
                CREATE TABLE IF NOT EXISTS {str('Cliente')+ titulo1 + str('entrada')} (
                nfe TEXT,
                serie TEXT,
                data_emissao TEXT,
                cnpj_emitente TEXT,
